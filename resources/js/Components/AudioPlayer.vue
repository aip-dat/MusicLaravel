...
<template>
    ...
    >
        <div id="audio-player-root" class="relative">
            <button
                class="absolute -top-4 -right-4 w-8 h-8 bg-gray-800 text-white rounded-full border-2 border-white"
            ...
            <div
                ...
                style="margin: auto"
            >
                <h4 class="text-md text-center text-gray-800 font-bold">
                    {{ playlist.nowPlaying.title }}
                </h4>

                <div
                    id="player-row"
                    class="inline-flex flex-wrap items-center w-full max-w-5xl px-8"
                >
                    <div id="button-div" class="flex-initial pr-3 space-x-2">
                        <button
                            :disabled="!playlist.isBackable"
                            @click="playlist.back()"
                        ...
                        <button
                            ...
                            class="h-8 w-8 inline-grid place-items-center rounded-full bg-gray-800 hover:bg-gray-500 text-white"
                            @click="toggleAudio()"
                        >
